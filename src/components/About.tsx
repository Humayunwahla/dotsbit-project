    ...
    <div className='about   lg:mx-[126px] mx-[50px]'>
     <div className='flex lg:flex-row flex-col text-center mt-20'>
        ...
        <div className='lg:w-5/6 text-left mt-6 lg:mt-0'>
            <p className=' font-poppins text-xl'>At Dotsbit, we firmly believe in the power of turning dreams into reality.
               ...
               and unwavering support, your vision can transform into a flourishing actuality.</p>
        </div>
     </div>
    </div>
